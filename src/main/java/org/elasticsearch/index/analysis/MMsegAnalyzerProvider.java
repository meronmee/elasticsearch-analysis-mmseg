...
public class MMsegAnalyzerProvider extends AbstractIndexAnalyzerProvider<MMSegAnalyzer>  {
    ...
    public static AnalyzerProvider<? extends Analyzer> getDicFirst(IndexSettings indexSettings, Environment environment, String s, Settings settings) {
        return  new MMsegAnalyzerProvider(indexSettings,environment,s,settings,new DicFirstAnalyzer(Dictionary.getInstance()));
    }
