...
public class MMsegTokenizerFactory extends AbstractTokenizerFactory {
    ...
    public static TokenizerFactory getDicFirst(IndexSettings indexSettings, Environment environment, String name, Settings settings) {
        return new MMsegTokenizerFactory(indexSettings,environment,name,settings,new DicFirstSeg(Dictionary.getInstance()));
    }
